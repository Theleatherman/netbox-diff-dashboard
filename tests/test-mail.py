...
dummy_diff = {
    "added": [["10.1.1.1/24", "Neue Firewall", "fw01", ["firewall", "mgmt-if"]]],
    "removed": [["10.1.1.2/24", "Altes Backend", "backend01", ["dmz", "db"]]],
    "changed": {
        "10.1.1.3/24": {
...
body_plain = (
    "Dies ist eine Testmail mit Beispiel-Änderungen (bitte HTML-Ansicht aktivieren)."
)
